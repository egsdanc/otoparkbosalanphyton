...
while True:
    ...
    if counter == 2: # sadece 2 noktaya tıklandığında içerisine girer ve tupleye değerleri kaydeder
        x1 = pos_matrix[0][0] #x1 kordinatının kayıt edildiği matrisin değerini starting_x değişkenine atıyoruz
        y1 = pos_matrix[0][1]
 
        x2 = pos_matrix[1][0]
        y2 = pos_matrix[1][1]     
        
        posList.append((x1,y1,x2,y2))  #tuple içerisine x1,y1,x2,y2 değişkenlerini atıyoruz
